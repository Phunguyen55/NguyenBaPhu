...
<head>
    ...
    <link href="{{asset('public/frontend/css/fonts-awesome.min.css')}}" rel="stylesheet">
    ...
    <link rel="apple-touch-icon-precomposed" href="{{ asset('public/frontend/images/ico/apple-touch-icon-57-precomposed.pn') }}">
</head><!--/head-->
